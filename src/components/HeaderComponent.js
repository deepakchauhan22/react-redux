...
import { Navbar, NavbarBrand ,NavbarToggler, Collapse,NavItem
    ,Jumbotron, Nav,Button,Modal,ModalHeader,ModalBody,Form,  FormGroup, Label, Input} from 'reactstrap';
     ...
     <Navbar expand="md" >
      <div className="container">
        ...
        <NavbarBrand  className ="mr-auto" href="/">
            <img src = {logo} height="30" width = "41" alt = "Resto"/>
        </NavbarBrand>
